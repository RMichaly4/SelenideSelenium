...
import static ui.pageObjects.ApplicationActions.TemplateType.*;
import static ui.pageObjects.ApplicationActions.drpdwnListValues_1.*;

public class ApplicationActionsTest extends BrowserSettings {
    ...
    public void selectUserProfile() throws Exception {
        applicationActions.selectProfile(user3);
    }
